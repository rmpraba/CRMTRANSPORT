...
{
  var schoolx={"school_id":req.query.schoolid};
  connection.query('SELECT * from trip_to_grade  where ? and academic_year="'+req.query.academic_year+'" and grade_name="'+res.query.gradename+'"',[schoolx],
        function(err, rows)
        {
    if(!err)
    {
